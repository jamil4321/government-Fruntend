...
// import { Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, Avatar, User,NavbarContent } from "@nextui-org/react";
        ...
        <div id="navbarname">
          ...
          <NavbarBrand className="m-0" style={{ height: '90px' }}>
            <div onClick={NavigateFunc} style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              <img alt="logo" id="navbarimg" src="https://th.bing.com/th?id=OIP.LhNZyOyY6Se-L3FaYDTklwHaEc&w=322&h=193&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2" style={{ width: '110px', marginLeft: '-20px', height: '70px' }} />
